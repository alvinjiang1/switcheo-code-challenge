...
const (
	...
	Query_SayHello_FullMethodName = "/blockchain.blockchain.Query/SayHello"
	Query_ShowPost_FullMethodName = "/blockchain.blockchain.Query/ShowPost"
	Query_ListPost_FullMethodName = "/blockchain.blockchain.Query/ListPost"
)
